# -*- coding: utf-8 -*-
"""
Created on Sun Jul 28 16:08:32 2019
...
if __name__=="__main__":
    #对训练集进行分词
    corpus_path = "./fudan/train_corpus/"  # 未分词分类语料库路径
    seg_path = "./fudan/train_corpus_seg/"  # 分词后分类语料库路径
    corpus_segment(corpus_path,seg_path)
 
    #对测试集进行分词
    corpus_path = "./fuda/test_corpus/"  # 未分词分类语料库路径
    seg_path = "./fudan/test_corpus_seg/"  # 分词后分类语料库路径
    corpus_segment(corpus_path,seg_path)
